...
def load_documents(folder_path):
    """Carrega documentos TXT e PDF da pasta indicada e retorna uma lista de Documentos."""
    documents = []
...
system_message = SystemMessage(content=(
    "Você é um assistente virtual especializado no atendimento ao cliente para uma renomada marca de Drones. "
    ...
    "Caso a pergunta não esteja relacionada ao atendimento ao cliente, especificações de Drones, garantias, manutenções ou suporte técnico, "
...
def ask():
    ...
    # Se a resposta estiver vazia ou irrelevante, encaminha para atendimento humano
    if not answer or "Desculpe" in answer:
        answer = "Não consegui responder sua dúvida e irei repassar sua pergunta para um suporte especializado."
